...
export class Init1765273862649 implements MigrationInterface {
    name = 'Init1765273862649'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'user', 'provider')`);
